...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-white" data-testid="signup-page">
      <div className="flex items-center justify-center p-8 order-2 md:order-1">
        <form onSubmit={submit} className="w-full max-w-sm space-y-5" data-testid="signup-form">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">50 free lead qualifications, no card.</p>
          </div>
          ...
          <div className="text-sm text-slate-500 text-center">
            Already have an account? <Link to="/login" className="text-[#0044FF] font-medium">Sign in →</Link>
          </div>
        </form>
      </div>
      ...
      <div className="hidden md:block relative bg-[#050505] text-white grain order-1 md:order-2">
        ...
        <div className="relative p-12 flex flex-col justify-between h-full">
          ...
          <div>
            <div className="overline mb-3 text-white/50">Join 400+ teams</div>
